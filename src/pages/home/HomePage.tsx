    ...
    >
      ...
      <div className="w-full flex flex-col justify-center items-center gap-5 text-center px-4">
        ...
        <div className="flex flex-col gap-5 my-5">
          <Link to={'/news'} className="bg-blue-500 text-white font-semibold p-3 rounded-xl shadow-lg" >
            🗞️ 최신 리그 오브 레전드 소식 확인하기
          </Link>
          <Link to={'/guide'} className="bg-blue-500 text-white font-semibold p-3 rounded-xl shadow-lg" >
            🤔 도전! 롤든벨 플레이 방법 알아보기
          </Link>
        </div>
